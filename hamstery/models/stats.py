...
class HamsteryStats(SingletonModel):
    ...
    def update_title_parser_stats(self, calls=0, fails=0, prompt_tokens=0, completion_tokens=0, total_tokens=0):
        ...
        self.openai_title_parser_calls += calls
        self.openai_title_parser_failures += fails
        self.openai_title_parser_prompt_tokens_used += prompt_tokens
        self.openai_title_parser_completion_tokens_used += completion_tokens
        self.openai_title_parser_total_tokens_used += total_tokens
        self.save()
